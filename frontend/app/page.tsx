  ...
  return (
    <>
      <div className="relative">
        <div className="relative" style={{ backgroundColor: 'rgb(167 167 167)' }}>
          <div className="bg-gradient-to-b from-white w-full h-full absolute top-0"></div>
          <div className="container">
            <div className="relative min-h-[40vh] mx-auto max-w-2xl pt-10 xl:pt-20 pb-16 space-y-6 lg:max-w-4xl lg:px-12 flex flex-col items-center justify-center">
