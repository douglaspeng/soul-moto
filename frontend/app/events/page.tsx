                    ...
                    <div className="md:w-2/3 p-6 md:p-8">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          <Link href={`/events/${event._id}`} className="block hover:text-blue-600 transition-colors duration-200">
                            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 cursor-pointer">
                              {event.eventName}
                            </h2>
                          </Link>
